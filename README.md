...
- Add schema validation with explicit typed models (e.g., Pydantic).
- Add richer country metadata enrichment (country names, region income groups).
- Add incremental persistence/caching to avoid re-fetching unchanged pages.
- Add CI workflow for lint/test and automated packaging.
